...

{
	...
	//	$item2 = $_GET["item2"];
		...
		$queryResult = $pdo->prepare("SELECT codigo, nombre, pais FROM control_ci where correo = :email and b2 = 1 and tipo = 'CLUB' and estatus = 0");
...

		{
			...
			//$_SESSION['products'][$item1]=$item1."-1";
